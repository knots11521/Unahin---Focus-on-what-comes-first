    ...
    <div class="md:col-span-2 space-y-6">
        <div>
            ...
            <input type="text" name="title" id="title" value="{{ old('title', $task?->title) }}" required
                class="app-input px-4 py-3 text-slate-900 dark:text-white"
    ...
    <div class="space-y-6">
        <div>
            ...
            <select name="priority" id="priority" required
                class="app-input px-4 py-3 text-slate-900 dark:text-slate-300">
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <select name="tags[]" id="tags" multiple
                class="app-input px-4 py-3 text-slate-900 dark:text-slate-300 h-[105px]">
...
<div class="mt-10 pt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row justify-end items-center gap-4">
    ...
    <button type="submit" class="app-btn app-btn-primary w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-3 font-bold text-sm">
